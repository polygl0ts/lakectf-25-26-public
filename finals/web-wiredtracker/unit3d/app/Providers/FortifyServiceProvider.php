...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        RateLimiter::for('fortify-login-get', fn () => Limit::none());
        RateLimiter::for('fortify-register-get', fn () => Limit::none());
        RateLimiter::for('fortify-register-post', fn () => Limit::none());
        RateLimiter::for('two-factor', fn () => Limit::none());
