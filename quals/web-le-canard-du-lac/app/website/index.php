    ...
    <header class="py-5 bg-light border-bottom mb-4">
        <div class="container">
            <div class="text-center my-5">
                <h1 class="fw-bolder">Welcome to Le Canard du Lac!</h1>
                <p class="lead mb-0">The only reliable news source from the shores of Lake Leman.</p>
            </div>
        </div>
    </header>
